...
<?php if($session['title'] and !$session['hide_title']): ?>
  <header><h1>
    ...
    <span><?php echo $session['start_datetime']; ?></span>
    <?php if(!is_null($session['end_datetime'])): ?>&#8212;<span><?php echo $session['end_datetime']; ?></span><?php endif; ?>
    <?php endif; ?>
...
<?php endif; ?>
<?php
  process_subsession_templates($session['sessions']);
?>    
