...
function pages_prepare_newsletter($id) {
  /**
  ...
  $newsletter_title_meta = strtolower(get_post_meta($id, 'newsletter_title_meta', true));
  ...
  $theme_skin = strtolower(get_post_meta($id, 'theme_skin', true));
  ...
  $newsletter = array(
    ...
    'our_permalink' => $our_permalink,
    'teaser' => get_post_meta($id, "campaign_teaser_text", true),
    'heading_link' => get_post_meta($id, "campaign_heading_link", true),
