...
var_trace(var_export($current_projects, true), $TRACE_PREFIX . ' - active projects (by strand): ', $TRACE_ENABLED);
$past_projects = compose_project_list_by_strand('completed');
var_trace(var_export($past_projects, true), $TRACE_PREFIX . ' - completed projects (by strand): ', $TRACE_ENABLED);
