      ...
      //<![CDATA[
        ...
        jQuery(document).ready(function($) {
          ...
          if($('#mc_embed_signup input#mce-2013CONF').length > 0) {
            ...
            $('#mc_embed_signup textarea#mce-2013CONF').css({height: '100px', width: '100%', padding: '8px', border: '1px solid #999', 'box-sizing': 'border-box'}).attr({placeholder: 'Please tell us why you are interested in the Urban Age City Transformations conference'});
          }
